...
- экран `Progress` с аналитикой по серверным тренировкам;
...
- работа на backend-хранилище с отдельным JSON-справочником упражнений;
...
- справочник упражнений загружается из JSON-файла;
...
- все экраны работают на серверной истории тренировок текущего пользователя;
