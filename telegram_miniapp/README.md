...
- в set-modal можно отметить тяжесть подхода через `🙂 / 😐 / 😣`;
...
- выбор тяжести подхода через `🙂 / 😐 / 😣` в set-modal;
- центрированная модалка удаления по long press на карточке упражнения;
