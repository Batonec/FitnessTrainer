...
и тренерскую политику (частота, недельные объёмы на группу, волны интенсивности, RIR,
прогрессия, deload, питание по тренду веса); в запрос подаются вычисленные недельные
объёмы по группам, тренд веса тела и сверка «факт vs план» последней тренировки.
