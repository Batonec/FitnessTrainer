...
- [backend/web/data/exercises.json](./web/data/exercises.json) — каталог упражнений (отдаётся клиенту по `/data/exercises.json`)
...
- `MINIAPP_STATIC_DIR` — каталог со статикой (`web/`), откуда отдаётся `/data/exercises.json`
